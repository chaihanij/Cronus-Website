...
class OperatingSystemsControllerTest < ActionController::TestCase
  ...
  test "should create operating_system" do
    assert_difference('OperatingSystem.count') do
      post :create, operating_system: { description: @operating_system.description, is_public: @operating_system.is_public, name: @operating_system.name, version: @operating_system.version }
    end
  ...
  test "should update operating_system" do
    patch :update, id: @operating_system, operating_system: { description: @operating_system.description, is_public: @operating_system.is_public, name: @operating_system.name, version: @operating_system.version }
    assert_redirected_to operating_system_path(assigns(:operating_system))
  end
